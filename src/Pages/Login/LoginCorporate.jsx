...
const LoginCorporate = () => {
  ...
  return (
    <div className='w-full h-full flex flex-col items-center justify-center p-2'>
      ...
      <h2 className='text-xl md:text-4xl font-bold text-center mb-2'>Corporate<span className='text-main ml-2'>Account</span></h2>
      ...
      <div className="w-full flex flex-col items-center justify-center">
        <form className='w-full md:w-2/3 lg:w-1/3 p-4 border border-gray-300 rounded-lg' onSubmit={handleSubmit}>
          ...
          <p className='my-2 text-sm md:text-lg'>Don&#39;t you have an account?
            <Link to='/register/corporate'><span className='text-main font-bold ml-1'>Sign Up</span></Link>
          </p>
          <Link to='/forgetPassword/corporate'><p className='text-main font-bold my-2 text-sm md:text-lg'>Forgot Password?</p></Link>
