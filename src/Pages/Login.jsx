...
const Login = () => {
  ...
  return (
    <div className='my-16'>
      ...
      <h2 className='mb-8 text-4xl font-bold text-center text-blue-700'>Sign In</h2>
      <div className="flex items-center justify-center">
        <form className='w-full md:w-2/3 lg:w-1/3 p-4 border border-gray-300 p-4 rounded-lg' onSubmit={handleSubmit}>
          ...
          <p className='my-2'>Don&#39;t you have an account?
            <Link to='/registration'><span className='text-blue-800 font-bold ml-1'>Sign Up</span></Link>
          </p>
          <Link to='/forgetPassword'><p className='text-blue-700 font-bold my-2'>Forgot Password?</p></Link>
          <button type='submit' className='flex items-center justify-start px-4 py-2 text-md text-white bg-blue-800 rounded-lg font-semibold shadow-sm' disabled={isFetching}>
