...
const SavingModal = ({ product, merchant, onClose }) => {
  ...
  return (
    <div className='h-screen w-screen fixed bottom-0 left-0 right-0 top-0 z-50'>
      ...
      <div className="absolute top-32 left-0 right-0 mx-auto w-5/6 md:w-1/2 xl:w-1/3 min-h-[50%] rounded-lg bg-white text-black p-4 md:p-8">
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <p className='text-center mb-6 text-sm md:text-lg text-main font-bold'>
            You are about to save for the {product?.merchantProductName} form {merchant?.merchantName}
          </p>
